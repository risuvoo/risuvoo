...
export const personalInfo: PersonalInfo = {
  ...
  subTitle:
    "Specializing in High-Performance Frontend Architectures, Microfrontends & AI-Augmented Engineering",
...
export const projects: Project[] = [
  {
    ...
    whatIDid:
      "Designed <strong>responsive SaaS software landing page architecture</strong>, built interactive hero sections, <strong>dynamic pricing breakdown matrices</strong>, and implemented <strong>fluid GSAP and jQuery micro-animations</strong>.",
  ...
  },
  {
    ...
    whatIDid:
      "Developed frontend interfaces for <strong>event listings</strong>, <strong>ticket selection</strong>, and <strong>booking workflows</strong>, including a <strong>custom auditorium layout builder</strong> to dynamically organize and manage seating arrangements.",
  ...
  },
  {
    ...
    whatIDid:
      "Built <strong>modular React component templates</strong> with <strong>interactive micro-animations</strong> using GSAP and TailwindCSS for high-performance rendering.",
  ...
  },
  {
    ...
    whatIDid:
      "Implemented <strong>marketplace frontend architecture</strong> including <strong>product catalog listings</strong>, <strong>subscription billing</strong>, and <strong>payment method integration</strong>.",
  ...
  },
  {
    ...
    whatIDid:
      "Built and managed frontend workflows for <strong>vendors</strong>, <strong>products</strong>, <strong>order management</strong>, <strong>Flying Cart animation</strong>, <strong>Google Maps delivery tracking</strong>, <strong>real-time chat</strong>, <strong>social login</strong>, <strong>payment gateway integration</strong>, <strong>SEO friendly setup</strong>, and <strong>language/currency switcher</strong>.",
    techStack: [
      "Next.js SSR",
      "TailwindCSS",
      "Laravel Eco",
  ...
  },
  {
    ...
    whatIDid:
      "Developed type-safe frontend features for <strong>directory listings</strong>, <strong>filtering engine</strong>, <strong>category-based unique pages</strong>, <strong>subscription checkout</strong>, <strong>payment method integration</strong>, <strong>listing CRUD</strong>, <strong>ADS management</strong>, and <strong>role management</strong>.",
    techStack: [
      "TypeScript",
      "Next.js SSR",
      "TailwindCSS",
  ...
  },
  {
    ...
    whatIDid:
      "Engineered <strong>hotel listing reservation interfaces</strong>, dynamic <strong>search filter bars</strong>, <strong>photo gallery sliders</strong>, <strong>availability calendar pickers</strong>, and <strong>customer review cards</strong>.",
  ...
  },
  {
    ...
    whatIDid:
      "Owned frontend development of LMS features including <strong>course enrollment</strong>, <strong>content playback views</strong>, <strong>e-commerce for digital product & resource selling</strong>, and <strong>training management</strong>.",
  ...
  },
  {
    ...
    whatIDid:
      "Designed and implemented modern <strong>analytical admin and dashboard solutions</strong> tailored to meet the unique needs of <strong>financial, analytical, and transaction monitoring companies</strong>.",
  ...
  },
  {
    ...
    whatIDid:
      "Built and managed frontend workflows for <strong>vendors</strong>, <strong>products</strong>, <strong>order management</strong>, <strong>social login</strong>, <strong>payment gateway integration</strong>, <strong>SEO friendly setup</strong>, <strong>language/currency switcher</strong>, and <strong>theme management</strong>.",
  ...
  },
  {
    ...
    description: "Learning Management System (LMS)",
    whatIDid:
      "Developed and maintained frontend architecture for <strong>course management</strong>, <strong>video streaming</strong>, <strong>quiz engine</strong>, <strong>playlist management</strong>, <strong>credit management</strong>, and <strong>custom Vimeo video player integration</strong>.",
  ...
  },
  {
    ...
    whatIDid:
      "Designed and developed the <strong>complete Chrome extension UI and core background logic</strong> to organize, inspect, copy, and <strong>reuse CSS utilities</strong>.",
    techStack: ["HTML", "CSS", "JavaScript"],
    liveUrl:
      "https://chromewebstore.google.com/detail/CSS%20Unites/bgbjdaligcmcobjgnhajolfhhhgjmoad",
    githubUrl: "https://github.com/risuvoo",
    featured: true,
  },
];
...
export const testimonial: Testimonial = {
  quote:
    "Rafiqul is an exceptional software engineer and frontend architect. His technical depth in modern frontend development, scalable architectures, and full-stack engineering combined with product-focused leadership makes him an invaluable engineering asset.",
