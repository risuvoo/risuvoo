    ...
    if (formData.name && formData.email && formData.message) {
      ...
      try {
        await fetch("/api/contact", {
          ...
          body: JSON.stringify({
            ...formData,
            _renderTime: renderTimeRef.current,
          }),
        });
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="space-y-4 text-center max-w-3xl mx-auto">
          ...
          <p className="text-base text-stone-600 font-medium">
            Have a project in mind, engineering leadership query, or
            opportunity? Drop me a message below.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="paper-card p-6 sm:p-8 space-y-6 bg-[#f7f6f0]">
              ...
              <div className="space-y-5">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <span className="block text-xs font-extrabold uppercase text-stone-500">
                      Email Address
                    </span>
                    <a
            ...
            <div className="paper-card p-6 bg-[#e9f02c] space-y-2">
              ...
              <p className="text-xs text-stone-900 font-bold leading-relaxed">
                ...
                architecture consulting or project inquiries, feel free to reach
            ...
            <div className="paper-card p-6 sm:p-8 space-y-6">
              ...
              {submitted ? (
                <div className="p-8 bg-emerald-100 border-2 border-[#1c1917] text-center space-y-3 shadow-[4px_4px_0px_0px_#1c1917]">
                  ...
                  <h4 className="text-2xl font-black text-[#1c1917]">
                    Message Received!
                  </h4>
                  <p className="text-sm font-bold text-stone-700">
                    Thank you for reaching out, {formData.name}. I will get back
                    to you shortly!
                  </p>
                </div>
              ) : (
